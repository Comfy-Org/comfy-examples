...
const workflowPath = join(process.cwd(), "blueprints", "room-remix.compiled.json");
...
function findNodeId(workflow: Awaited<ReturnType<Comfy["workflows"]["fromFile"]>>, classType: string) {
