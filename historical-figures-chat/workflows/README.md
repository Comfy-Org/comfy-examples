...
| Node ID | Input | Value |
| --- | --- | --- |
| `114` | `image` | selected public-domain portrait, uploaded as a Comfy asset |
| `2585308530609103` | `system_prompt` | historical persona and safety constraints |
| `2585308530609103` | `user_prompt` | the last 12 chat messages and a request for spoken words only |
